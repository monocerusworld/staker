...
import { ITartzPool, TestERC20 } from '../../typechain'
...
export const getSlot0 = async (pool: ITartzPool) => {
  if (!pool.signer) {
...
export const getCurrentTick = async (pool: ITartzPool): Promise<number> => (await getSlot0(pool)).tick

...
interface ISwapRouterInterface extends ethers.utils.Interface {
  functions: {
    ...
    'TartzSwapCallback(int256,int256,bytes)': FunctionFragment
  }
  ...
  encodeFunctionData(functionFragment: 'TartzSwapCallback', values: [BigNumberish, BigNumberish, BytesLike]): string
  ...
  decodeFunctionResult(functionFragment: 'TartzSwapCallback', data: BytesLike): Result
...
export class ISwapRouter extends Contract {
  ...
  functions: {
    ...
    'TartzSwapCallback(int256,int256,bytes)'(
      amount0Delta: BigNumberish,
      amount1Delta: BigNumberish,
      data: BytesLike,
      overrides?: Overrides
